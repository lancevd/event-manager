      ...
      <nav className="contain ">
        <div className="flex flex-wrap justify-between items-center ">
          ...
          <div className="flex items-center lg:order-2">
            ...
            <Link
              to={"/dashboard"}
              className={`text-white border bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-xs sm:text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800 ${isLoggedIn && "hidden"}`}
            >
              Create Event
            </Link>
            <button
